...
public class PluginWrapper : MonoBehaviour {
	...
	void Update () {
		...
		hand.transform.rotation = Quaternion.Euler (manager.GetComponent<Manager_New> ().z_Bew, manager.GetComponent<Manager_New> ().y_Bew, manager.GetComponent<Manager_New> ().x_Bew);
		greif = manager.GetComponent<Manager_New> ().greif;
		greifen (greif);
		if (snapzo != null) {
